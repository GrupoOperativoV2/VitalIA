...
export function ProfilePatient() {
    ...
    const info = {
        ...
        interests: [
          ...
          hobbyImages: [
            { url: 'https://example.com/path/to/hobby-image1.jpg', altText: 'Imagen de Ajedrez' },
            { url: 'https://example.com/path/to/hobby-image2.jpg', altText: 'Imagen de Ciclismo' },
            // ...otras imágenes de hobbies
          ],
          hobbiesNotes: 'He estado practicando ajedrez los fines de semana y participando en competiciones locales. El ciclismo me ayuda a mantenerme en forma y disfruto explorando rutas escénicas. Recientemente, comencé a aprender pintura para explorar mi lado creativo.',
         
        healthGoals: [
            { name: 'Perder Peso', description: 'Perder 5 kg', progress: 60 },
            { name: 'Ejercicio Regular', description: 'Correr 3 veces a la semana', progress: 75 },
            { name: 'Dieta Saludable', description: 'Comer 5 porciones de fruta y verdura al día', progress: 80 },
            // ...otros objetivos
          ],
          achievements: [
          ...
          reminders: [
            ...
            { title: 'Hora de correr', time: '07:00 PM', frequency: 'Lunes, Miércoles y Viernes' },
            // ...otros recordatorios
          ],
        medicalHistory: [
          {
      ...
      return (
        ...
        <NavContainer>
        <TabButton onClick={() => setActiveTab('medicalHistory')}>Historial Médico</TabButton>
                <TabButton onClick={() => setActiveTab('blog')}>Blog</TabButton>
                <TabButton onClick={() => setActiveTab('healthGoals')}>Logros y Objetivos de Salud</TabButton>
                <TabButton onClick={() => setActiveTab('interestsHobbies')}>Intereses y Hobbies</TabButton>
        </NavContainer>
          <Content>
            <div style={{ flex: 1 }}>
