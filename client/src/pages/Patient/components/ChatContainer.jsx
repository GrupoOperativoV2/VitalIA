      ...
      <div className="chat-header">
        <div className="user-details">
          <div className="avatar">
            <img src={currentChat?.doctorPhoto ? `http://159.223.161.190:4000${currentChat?.doctorPhoto.replace(/\\+/g, "/")}` : defaultAvatar}alt="Avatar"   style={{ width: 50, height: 50, borderRadius: "50%" }}/>
          </div>
