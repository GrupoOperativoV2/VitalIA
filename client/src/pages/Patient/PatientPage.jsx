...
export function PatientPage() {
  ...
  const historyID = history ? history._id : null; // Solo accede a _id si history no es null
  ...
  return (
    <PatientPageContainer>
      ...
      <BodyContainer>
        ...
        {!isHistorySubmitted && popupVisible && (
          <Popup
            show={popupVisible}
            onClose={togglePopup}
            title={user ? `Bienvenido, ${user.username}!` : "Bienvenido a nuestra aplicación!"}
          >
            <WelcomeMessage>
      ...
      <ContentSidebarContainer>
        {history && <Dashboard historyID={historyID} />}
      </ContentSidebarContainer>
