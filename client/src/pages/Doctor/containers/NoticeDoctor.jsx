...
export function NoticeDoctor() {
  ...
  return (
    <DiscoveryTab>
      <WelcomeMessage>
        <WelcomeTitle>
         Centro de Descubrimientos Médicos
        </WelcomeTitle>
        <WelcomeText>
          Explora los últimos avances y descubrimientos en el mundo de la
          medicina.
        </WelcomeText>
      </WelcomeMessage>
      ...
      {articles.length > 0 ? (
        articles.map((article, index) => (
          ...
          >
            <NewsImage
              src={article.urlToImage || "https://via.placeholder.com/120"}
              alt="Noticia"
            />
            <NewsContent>
